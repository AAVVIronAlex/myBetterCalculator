...
question_1 = input ("Input either of these (sum, difference, squareeq, multiply, division, root, power, percentage, squareofthesum, squareofthedifference (more coming soon)): ")
